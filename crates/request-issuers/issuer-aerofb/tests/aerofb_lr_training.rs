...
const NAME: &str = "aerofb_lr_training";

#[::tokio::test]
#[traced_test]
async fn aerofb_lr_training() -> ::anyhow::Result<()> {
    //
    // TODO(ckatsak): fork/exec:
    //      `docker run --rm -it --pull=always -p 8000:8000 ghcr.io/aero-project-eu/aerofb-lr_training:0.0.1`
