...
const NAME: &str = "aerofb_video_processing";

#[::tokio::test]
#[traced_test]
async fn aerofb_video_processing() -> ::anyhow::Result<()> {
    //
    // TODO(ckatsak): fork/exec:
    //      `docker run --rm -it --pull=always -p 8000:8000 ghcr.io/aero-project-eu/aerofb-video_processing:0.0.1`
