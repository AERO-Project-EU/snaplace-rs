...
const NAME: &str = "aerofb_lr_serving";

#[::tokio::test]
#[traced_test]
async fn aerofb_lr_serving() -> ::anyhow::Result<()> {
    //
    // TODO(ckatsak): fork/exec:
    //      `docker run --rm -it --pull=always -p 8000:8000 ghcr.io/aero-project-eu/aerofb-lr_serving:0.0.1`
