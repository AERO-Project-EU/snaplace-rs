...
impl FirecrackerClient {
    ...
    pub async fn load_vm_snapshot(&self, ctx: ttrpc::context::Context, req: &super::firecracker::LoadVMSnapshotRequest) -> ::ttrpc::Result<super::firecracker::LoadVMSnapshotResponse> {
        let mut cres = super::firecracker::LoadVMSnapshotResponse::new();
        ::ttrpc::async_client_request!(self, ctx, req, "fc_ctrd.Firecracker", "LoadVMSnapshot", cres);
    }

    pub async fn unload_vm(&self, ctx: ttrpc::context::Context, req: &super::firecracker::UnloadVMRequest) -> ::ttrpc::Result<super::empty::Empty> {
        let mut cres = super::empty::Empty::new();
        ::ttrpc::async_client_request!(self, ctx, req, "fc_ctrd.Firecracker", "UnloadVM", cres);
    }
...
struct CreateVmMethod {
    service: Arc<dyn Firecracker + Send + Sync>,
}
...
struct UnloadVmMethod {
    service: Arc<dyn Firecracker + Send + Sync>,
}

#[async_trait]
impl ::ttrpc::r#async::MethodHandler for UnloadVmMethod {
    async fn handler(&self, ctx: ::ttrpc::r#async::TtrpcContext, req: ::ttrpc::Request) -> ::ttrpc::Result<::ttrpc::Response> {
        ::ttrpc::async_request_handler!(self, ctx, req, firecracker, UnloadVMRequest, unload_vm);
    }
}
...
pub trait Firecracker: Sync {
    ...
    async fn load_vm_snapshot(&self, _ctx: &::ttrpc::r#async::TtrpcContext, _: super::firecracker::LoadVMSnapshotRequest) -> ::ttrpc::Result<super::firecracker::LoadVMSnapshotResponse> {
    ...
    async fn unload_vm(&self, _ctx: &::ttrpc::r#async::TtrpcContext, _: super::firecracker::UnloadVMRequest) -> ::ttrpc::Result<super::empty::Empty> {
        Err(::ttrpc::Error::RpcStatus(::ttrpc::get_status(::ttrpc::Code::NOT_FOUND, "/fc_ctrd.Firecracker/UnloadVM is not supported".to_string())))
    }
...
pub fn create_firecracker(service: Arc<dyn Firecracker + Send + Sync>) -> HashMap<String, ::ttrpc::r#async::Service> {
    ...
    methods.insert("UnloadVM".to_string(),
                    Box::new(UnloadVmMethod{service: service.clone()}) as Box<dyn ::ttrpc::r#async::MethodHandler + Send + Sync>);
