...
pub struct CreateVMResponse {
    ...
    // @@protoc_insertion_point(field:fc_ctrd.CreateVMResponse.PID)
    pub PID: u64,
    // special fields
...
impl CreateVMResponse {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "PID",
            |m: &CreateVMResponse| { &m.PID },
            |m: &mut CreateVMResponse| { &mut m.PID },
        ));
...
impl ::protobuf::Message for CreateVMResponse {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.PID != 0 {
            my_size += ::protobuf::rt::uint64_size(6, self.PID);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.special_fields.unknown_fields());
        self.special_fields.cached_size().set(my_size as u32);
        my_size
...
// @@protoc_insertion_point(message:fc_ctrd.LoadVMSnapshotResponse)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct LoadVMSnapshotResponse {
    // message fields
    // @@protoc_insertion_point(field:fc_ctrd.LoadVMSnapshotResponse.VMID)
    pub VMID: ::std::string::String,
    // @@protoc_insertion_point(field:fc_ctrd.LoadVMSnapshotResponse.PID)
    pub PID: u64,
    // special fields
    // @@protoc_insertion_point(special_field:fc_ctrd.LoadVMSnapshotResponse.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}

impl<'a> ::std::default::Default for &'a LoadVMSnapshotResponse {
    fn default() -> &'a LoadVMSnapshotResponse {
        <LoadVMSnapshotResponse as ::protobuf::Message>::default_instance()
    }
}

impl LoadVMSnapshotResponse {
    pub fn new() -> LoadVMSnapshotResponse {
        ::std::default::Default::default()
    }
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "VMID",
            |m: &LoadVMSnapshotResponse| { &m.VMID },
            |m: &mut LoadVMSnapshotResponse| { &mut m.VMID },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "PID",
            |m: &LoadVMSnapshotResponse| { &m.PID },
            |m: &mut LoadVMSnapshotResponse| { &mut m.PID },
        ));
        ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<LoadVMSnapshotResponse>(
            "LoadVMSnapshotResponse",
            fields,
            oneofs,
        )
    }
...
impl ::protobuf::Message for LoadVMSnapshotResponse {
    const NAME: &'static str = "LoadVMSnapshotResponse";
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.PID != 0 {
            my_size += ::protobuf::rt::uint64_size(2, self.PID);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.special_fields.unknown_fields());
        self.special_fields.cached_size().set(my_size as u32);
        my_size
    ...
    fn new() -> LoadVMSnapshotResponse {
        LoadVMSnapshotResponse::new()
    }
    ...
    fn default_instance() -> &'static LoadVMSnapshotResponse {
        static instance: LoadVMSnapshotResponse = LoadVMSnapshotResponse {
            VMID: ::std::string::String::new(),
            PID: 0,
            special_fields: ::protobuf::SpecialFields::new(),
        };
...
impl ::protobuf::MessageFull for LoadVMSnapshotResponse {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("LoadVMSnapshotResponse").unwrap()).clone()
    }
}

impl ::std::fmt::Display for LoadVMSnapshotResponse {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for LoadVMSnapshotResponse {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}
...
impl ::protobuf::Enum for DriveExposePolicy {
    ...
    fn from_str(str: &str) -> ::std::option::Option<DriveExposePolicy> {
        match str {
            "COPY" => ::std::option::Option::Some(DriveExposePolicy::COPY),
            "BIND" => ::std::option::Option::Some(DriveExposePolicy::BIND),
            _ => ::std::option::Option::None
        }
    }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ath\x18\x05\x20\x01(\tR\nCgroupPath\x12\x10\n\x03PID\x18\x06\x20\x01(\
    \x04R\x03PID\"$\n\x0ePauseVMRequest\x12\x12\n\x04VMID\x18\x01\x20\x01(\t\
    R\x04VMID\"%\n\x0fResumeVMRequest\x12\x12\n\x04VMID\x18\x01\x20\x01(\tR\
    \x04VMID\"s\n\x17CreateVMSnapshotRequest\x12\x12\n\x04VMID\x18\x01\x20\
    \x01(\tR\x04VMID\x12\"\n\x0cSnapshotPath\x18\x02\x20\x01(\tR\x0cSnapshot\
    Path\x12\x20\n\x0bMemFilePath\x18\x03\x20\x01(\tR\x0bMemFilePath\"\x8d\
    \x01\n\x15LoadVMSnapshotRequest\x12\x12\n\x04VMID\x18\x01\x20\x01(\tR\
    \x04VMID\x12\"\n\x0cSnapshotPath\x18\x02\x20\x01(\tR\x0cSnapshotPath\x12\
    \x20\n\x0bMemFilePath\x18\x03\x20\x01(\tR\x0bMemFilePath\x12\x1a\n\x08Re\
    sumeVM\x18\x04\x20\x01(\x08R\x08ResumeVM\">\n\x16LoadVMSnapshotResponse\
    \x12\x12\n\x04VMID\x18\x01\x20\x01(\tR\x04VMID\x12\x10\n\x03PID\x18\x02\
    \x20\x01(\x04R\x03PID\"%\n\x0fUnloadVMRequest\x12\x12\n\x04VMID\x18\x01\
    \x20\x01(\tR\x04VMID\"K\n\rStopVMRequest\x12\x12\n\x04VMID\x18\x01\x20\
    \x01(\tR\x04VMID\x12&\n\x0eTimeoutSeconds\x18\x02\x20\x01(\rR\x0eTimeout\
    Seconds\"&\n\x10GetVMInfoRequest\x12\x12\n\x04VMID\x18\x01\x20\x01(\tR\
    \x04VMID\"\xd1\x01\n\x11GetVMInfoResponse\x12\x12\n\x04VMID\x18\x01\x20\
    \x01(\tR\x04VMID\x12\x1e\n\nSocketPath\x18\x02\x20\x01(\tR\nSocketPath\
    \x12\x20\n\x0bLogFifoPath\x18\x03\x20\x01(\tR\x0bLogFifoPath\x12(\n\x0fM\
    etricsFifoPath\x18\x04\x20\x01(\tR\x0fMetricsFifoPath\x12\x1e\n\nCgroupP\
    ath\x18\x05\x20\x01(\tR\nCgroupPath\x12\x1c\n\tVSockPath\x18\x06\x20\x01\
    (\tR\tVSockPath\"F\n\x14SetVMMetadataRequest\x12\x12\n\x04VMID\x18\x01\
    \x20\x01(\tR\x04VMID\x12\x1a\n\x08Metadata\x18\x02\x20\x01(\tR\x08Metada\
    ta\"I\n\x17UpdateVMMetadataRequest\x12\x12\n\x04VMID\x18\x01\x20\x01(\tR\
    \x04VMID\x12\x1a\n\x08Metadata\x18\x02\x20\x01(\tR\x08Metadata\"*\n\x14G\
    etVMMetadataRequest\x12\x12\n\x04VMID\x18\x01\x20\x01(\tR\x04VMID\"3\n\
    \x15GetVMMetadataResponse\x12\x1a\n\x08Metadata\x18\x01\x20\x01(\tR\x08M\
    etadata\"\xda\x01\n\x0cJailerConfig\x12\x14\n\x05NetNS\x18\x01\x20\x01(\
    \tR\x05NetNS\x12\x12\n\x04CPUs\x18\x02\x20\x01(\tR\x04CPUs\x12\x12\n\x04\
    Mems\x18\x03\x20\x01(\tR\x04Mems\x12\x10\n\x03UID\x18\x04\x20\x01(\rR\
    \x03UID\x12\x10\n\x03GID\x18\x05\x20\x01(\rR\x03GID\x12\x1e\n\nCgroupPat\
    h\x18\x06\x20\x01(\tR\nCgroupPath\x12H\n\x11DriveExposePolicy\x18\x07\
    \x20\x01(\x0e2\x1a.fc_ctrd.DriveExposePolicyR\x11DriveExposePolicy\"H\n\
    \x14UpdateBalloonRequest\x12\x12\n\x04VMID\x18\x01\x20\x01(\tR\x04VMID\
    \x12\x1c\n\tAmountMib\x18\x02\x20\x01(\x03R\tAmountMib\"-\n\x17GetBalloo\
    nConfigRequest\x12\x12\n\x04VMID\x18\x01\x20\x01(\tR\x04VMID\"c\n\x18Get\
    BalloonConfigResponse\x12G\n\rBalloonConfig\x18\x01\x20\x01(\x0b2!.fc_ct\
    rd.FirecrackerBalloonDeviceR\rBalloonConfig\",\n\x16GetBalloonStatsReque\
    st\x12\x12\n\x04VMID\x18\x01\x20\x01(\tR\x04VMID\"\xf5\x03\n\x17GetBallo\
    onStatsResponse\x12\x1c\n\tActualMib\x18\x01\x20\x01(\x03R\tActualMib\
    \x12\x20\n\x0bActualPages\x18\x02\x20\x01(\x03R\x0bActualPages\x12(\n\
    \x0fAvailableMemory\x18\x03\x20\x01(\x03R\x0fAvailableMemory\x12\x1e\n\n\
    DiskCaches\x18\x04\x20\x01(\x03R\nDiskCaches\x12\x1e\n\nFreeMemory\x18\
    \x05\x20\x01(\x03R\nFreeMemory\x12.\n\x12HugetlbAllocations\x18\x06\x20\
    \x01(\x03R\x12HugetlbAllocations\x12(\n\x0fHugetlbFailures\x18\x07\x20\
    \x01(\x03R\x0fHugetlbFailures\x12\x20\n\x0bMajorFaults\x18\x08\x20\x01(\
    \x03R\x0bMajorFaults\x12\x20\n\x0bMinorFaults\x18\t\x20\x01(\x03R\x0bMin\
    orFaults\x12\x16\n\x06SwapIn\x18\n\x20\x01(\x03R\x06SwapIn\x12\x18\n\x07\
    SwapOut\x18\x0b\x20\x01(\x03R\x07SwapOut\x12\x1c\n\tTargetMib\x18\x0c\
    \x20\x01(\x03R\tTargetMib\x12\x20\n\x0bTargetPages\x18\r\x20\x01(\x03R\
    \x0bTargetPages\x12\x20\n\x0bTotalMemory\x18\x0e\x20\x01(\x03R\x0bTotalM\
    emory\"e\n\x19UpdateBalloonStatsRequest\x12\x12\n\x04VMID\x18\x01\x20\
    \x01(\tR\x04VMID\x124\n\x15StatsPollingIntervals\x18\x02\x20\x01(\x03R\
    \x15StatsPollingIntervals*'\n\x11DriveExposePolicy\x12\x08\n\x04COPY\x10\
    \0\x12\x08\n\x04BIND\x10\x01B\x07Z\x05protob\x06proto3\
";
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(LoadVMSnapshotResponse::generated_message_descriptor_data());
